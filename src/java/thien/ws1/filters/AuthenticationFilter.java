...
/**
 * AuthenticationFilter is a servlet filter that checks if a user is authenticated
 * before allowing access to specific servlets. If the user is not authenticated,
 * they are redirected to the login page.
 * 
 * @author Thienlm30
 */
@WebFilter(filterName = "AuthenticationFilter", servletNames = {"ListAccountServlet", "ListCategoryServlet","AddProductServlet"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (action == null || action.equals(Action.WELCOME) || session.getAttribute("loginedAcc") != null) {
