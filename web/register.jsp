<%-- 
    Document   : register
    Created on : 22-Jun-2024, 18:07:19
    Author     : Thienlm30
--%>
        ...
        <div class="bg-gray-100 flex items-center justify-center h-full w-full p-8">
            <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-screen-xl">
                ...
                <form action="MainController" method="post">
                    ...
                    <div class="div-style">
                        <label class="label-style">Birthday</label>
                    ...
                    <div class="text-center">
                        <button type="submit" class="button-style" name="action" value="<%= Action.ADD_NEW_ACCOUNT %>">Add</button>
                    </div>
                </form>
            </div>
        </div>
